...
BASE_PORT = 9999               # lowest number of socket port to use with base station
USE_ACCEL = True                # read data from Shimmer3
USE_LIGHT = False                # read data from light sensor
USE_ADC = False                  # read data from the ADC - temperature and microphone
