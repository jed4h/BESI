...
#TEMP_PIN = "AIN6"               # ADC pin for temperature sensor input - no longer used
#MOTION_PIN = "P9_42"            # Montio detector out pin - no longer used
#HOST = '172.25.203.64'           # Base Station IP address - now obtained as user input
IS_STREAMING = True             # stream to base station 
IS_LOGGING = True               # log on Beaglebone
#BASE_PORT = 9999               # lowest number of socket port to use with base station - now a user input
